...
var executeNodelikeChildren = function executeNodelikeChildren(
  children,
  nodes,
) {
  var node = {};
...
var executeLinklikeChildren = function executeLinklikeChildren(
  children,
  links,
) {
  var link = {};
